...
git add README.md docs .gitignore mlops_azure/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[mlops_azure/databricks.yml](../mlops_azure/databricks.yml) file.
...
Follow the instructions in [mlops_azure/resources/README.md](../mlops_azure/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_azure/resources/README.md)  to propose, test, and deploy
