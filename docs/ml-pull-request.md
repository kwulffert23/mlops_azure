...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_azure-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/staging/mlops_azure/mlops_azure-model)
* [Prod model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/prod/mlops_azure/mlops_azure-model)
. 
